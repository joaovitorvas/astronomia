function enviar() {
    ...
    if (planeta == 'marte') {
        img.setAttribute('src', 'imagens/marte.jpg')
        ...
        img.setAttribute('src', 'imagens/terra.jfif')
        ...
        img.setAttribute('src', 'imagens/jupiter.jfif')
    ...
    img.setAttribute('src', 'imagens/netuno.jfif')
    ...
    img.setAttribute('src', 'imagens/venus.jfif')
    ...
    img.setAttribute('src', 'imagens/urano.jpg')
    ...
    img.setAttribute('src', 'imagens/mercurio.jfif')
